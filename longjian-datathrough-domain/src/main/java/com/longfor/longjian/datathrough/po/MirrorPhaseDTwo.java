...
@Table(name = "mirror_phase_d_two")
public class MirrorPhaseDTwo {
    @Id
    private Integer id;
     ...
     * 项目阶段
     */
    @Column(name = "pr_stage")
    private String prStage;
    ...
    public void setPrStage(String prStage) {
        this.prStage = prStage == null ? null : prStage.trim();
    }

    /**
     * 获取运营周期
     *
     * @return opperiod - 运营周期
     */
    ...
    public void setOpperiod(String opperiod) {
        this.opperiod = opperiod == null ? null : opperiod.trim();
    }
